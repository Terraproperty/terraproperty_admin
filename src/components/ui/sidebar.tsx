...
const AssociateProgramSidebarItem = () => (
...
const BuilderPropertySidebarItem = () => (
  <li data-sidebar="menu-item" className="group/menu-item relative">
    <Link
      href="/projects/builder-property"
      data-sidebar="menu-button"
      className="peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 truncate"
    >
      Builder Property
...
export {
  ...
  SidebarTrigger,
  useSidebar,
  AssociateProgramSidebarItem,
  BuilderPropertySidebarItem,
}
